                  ...
                  itemBuilder: (context, i) {
                    ...
                    return Card(
                      ...
                      child: ExpansionTile(
                        ...
                        subtitle: Text(
                          "Role: ${userData["role"]} | UID: ${user.id.substring(0, 5)}...",
                        ),
                        children: [_buildUserReportsList(db, user.id)],
                      ),
                    );
                  },
                ),
        ...
        return Column(
          children: reports.map((doc) {
            ...
            return ListTile(
              ...
              subtitle: Text(
                "W: ${data["weight"]}kg | F: ${data["bodyFatPercent"]}% | M: ${data["muscleMass"]}kg",
              ),
              trailing: IconButton(
                icon: const Icon(
